		...
		<div class="main-container">
			...
			<div class="bottom-cont">
				<div class="left-cont  ">
					...
					if ($menu) { ?>
						<div class="menu-cta row">
							<a href="<?php the_field('menu_pdf'); ?>" target=_blank>
								<span class="effra">Download</span>
								<img src="<?php echo get_template_directory_uri(); ?>/images/our_menu.png" alt="">
							</a>
						</div>
					<?php } else {?>
				...
				<div class="map-wrapper">
					<a href="https://www.google.com/maps/place/710+King+St,+Charleston,+SC+29403/@32.798969,-79.946458,17z/data=!3m1!4b1!4m2!3m1!1s0x88fe7a5cbd6a1605:0x863feefdd436a06f" target="_blank"><img class="map" src="<?php echo get_template_directory_uri(); ?>/images/mobile-map.jpg" alt=""></a>
